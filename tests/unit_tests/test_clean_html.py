...
def test_clean_html_ul_and_li_tags():
    print('============================', sys._getframe().f_code.co_name, '============================ ')
    output = clean_html('<p><strong>DIN ROLL:</strong></p><ul><li>Helhetsansvar för implementationsprocessen.</li><li>Planläggning och projektledning.</li><li>Analys och migrering av kundens data.</li></ul>Efter lista')
    # pprint(output)
...
def test_clean_script_tags():
    ...
    assert 'Lite text. Lite till. Och lite till.' == clean_html('<script>alert("test");</script>Lite text. Lite till. <script>alert("test");</script>Och lite till.')
